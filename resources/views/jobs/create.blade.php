	...
	<form method="post" action="{{route('job.store')}}" enctype="multipart/form-data">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" name="pr_name" class="form-control"  placeholder="نام وظیفه را وارد کنید!">
		...
		<div class="col-lg-5">
			<div class="form-group">
				...
				<input type="text"  name="en_name" class="form-control" placeholder="وظیفه را به انگلیسی وارد کنید!">
