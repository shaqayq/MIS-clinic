...
@section('content')
 ...
 <div class="card card-success card-outline">
	...
	<!-- /.card-header -->
	<!-- form start -->
	<form method="post" action="{{route('expend.store')}}" enctype="multipart/form-data">
		  @csrf
		<div class="card-body">
			<div class="row">
				<div class="col-lg-5">
				...
				<div class="col-lg-5">
					<div class="form-group">
						...
						<input type="text" name="cost" class="form-control"  placeholder="مقدار را به واحد افغانی وارد کنید!">
		    ...
		    <div class="row">
				<div class="col-lg-10">
					<div class="form-group">
						<label>از بابت:</label>
						<textarea name="behalf" class="form-control"></textarea>
