...
@section('content')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ویرایش بیماری</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <div class="card card-success card-outline">
	...
	<!-- /.card-header -->
	<!-- form start -->
	<form method="post" action="{{route('sicknees.update',$sick->id)}}" enctype="multipart/form-data">
		  @csrf
		  {{method_field('PATCH')}}
		<div class="card-body">
			<div class="row">
		...
		<div class="col-lg-5">
			<div class="form-group">
				...
				<input name="en_name" class="form-control" type="text" placeholder="نام بیماری را به لاتین وارد کنید.." value="{{$sick->eng_name}}">
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<input name="price" class="form-control" type="number" placeholder="فیس بیماری را وارد کنید.." value="{{$sick->price}}">
